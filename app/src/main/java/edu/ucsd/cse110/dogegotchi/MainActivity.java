...
import edu.ucsd.cse110.dogegotchi.daynightcycle.DogeWakeSleepMediator;
import edu.ucsd.cse110.dogegotchi.doge.Doge;
import edu.ucsd.cse110.dogegotchi.doge.DogeMoodObserver;
...
public class MainActivity extends Activity {
    ...
    private DogeMoodObserver dogeMoodObserver;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final DogeWakeSleepMediator dogeWakeSleepMediator = new DogeWakeSleepMediator(this.doge);
        ...
        this.dayNightCycleMediator.register(dogeWakeSleepMediator);
    ...
    private void createDoge(final int ticksPerPeriod) {
        ...
        this.dogeMoodObserver = new DogeMoodObserver(this, this.doge);

        // make the doge view observe doge's mood swings
        this.doge.register(this.dogeView);
        this.doge.register(this.dogeMoodObserver);
    }
